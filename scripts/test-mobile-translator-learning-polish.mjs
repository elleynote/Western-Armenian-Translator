...
const homeCss = read("src/components/HomeTranslatorExperience.module.css");
...
requireTerm("Mobile output layout", homeCss, '.experience :global(.output-panel .panel-body)');
requireTerm("Mobile output layout", homeCss, 'min-height: 0;');
requireTerm("Mobile output layout", homeCss, '.experience :global(.output-panel .translation-output)');
requireTerm("Mobile output layout", homeCss, 'min-height: 112px;');
requireTerm("Mobile output controls", homeCss, '.experience :global(.output-panel .panel-actions)');
